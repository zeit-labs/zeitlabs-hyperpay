...
"""
zeitlabs-hyperpay documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'zeitlabs-hyperpay',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/zeitlabs/zeitlabs-hyperpay",
...
#
# html_title = 'zeitlabs-hyperpay v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Hyperpay processor for Zeitlabs payments',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'hyperpay'),
                os.path.join(root_path, 'hyperpay/migrations')])
