...
class HyperPayClient:
    ...
    def _generate_access_token(self) -> None:
        ...
        try:
            ...
            raise HyperPayException(f'Error generating token: {exc}')
    
    def _ensure_token(self) -> None:
        """Ensure we have a valid token before making API calls."""
        if (
            not getattr(self, 'access_token', None)
            or not getattr(self, 'token_expiry', None)
    ...
    def create_checkout(self, payload: dict) -> Dict[str, str]:
        ...
        try:
            ...
            raise HyperPayException(f'Error creating a checkout. {exc}')
    ...
    def verify_checkout_status(self, params: dict) -> dict:
        ...
        try:
            ...
            raise HyperPayException(f'Error verifing checkout status. {exc}')
    ...
    def verify_webhook_callback_status(self, response_data):
