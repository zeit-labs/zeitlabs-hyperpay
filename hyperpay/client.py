...
class HyperPayClient:
    ...
    def __init__(self, access_token: str, base_url: str, entity_id: str, slug: str, test_mode: str = None) -> None:
        """Initialize client."""
        self.slug = slug
    ...
    def record_payment_response(self, response):
        try:
            data = response.json()
        except ValueError:
    ...
    def create_checkout(self, payload: dict) -> Dict[str, str]:
        ...
        try:
            ...
            self.record_payment_response(response)
