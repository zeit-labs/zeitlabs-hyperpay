...
class HyperPay(BaseProcessor):
    ...
    def get_cart_data(self, cart: Cart):
    ...
    def get_transaction_parameters(
        ...
        **kwargs: Any,
        ...
        checkout_payload = {
            ...
            'amount': f"{base_params['amount'] / 100:.2f}",
    ...
    def get_cart_from_reference(self, reference: str):
        """We are sending reference while creating checkout as site_id-cart_id that we"""
        try:
