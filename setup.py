...
VERSION = get_version('hyperpay', '__init__.py')
...
setup(
    name='zeitlabs-hyperpay',
    version=VERSION,
    description="""Hyperpay processor for Zeitlabs payments""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/zeitlabs/zeitlabs-hyperpay',
    packages=find_packages(
        include=['hyperpay', 'hyperpay.*'],
        exclude=["*tests"],
    ),
